...
transform_set = [
     ...
     transforms.ColorJitter((0,2), (0,2), (0, 2), (0.0, 0.1)),
     transforms.GaussianBlur(9,0.5)
]
...
testset = torchvision.datasets.ImageFolder(root="../food11re/food11re/evaluation")
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(30, 25, 3)
        self.relu4 = nn.LeakyReLU(0.01)
        self.pool4 = nn.MaxPool2d(2)
        self.conv5 = nn.Conv2d(25, 25, 3)
        self.relu5 = nn.LeakyReLU(0.01)
        self.pool5 = nn.MaxPool2d(2)
        self.fc1 = nn.Linear(625, 625)
        self.relu3 = nn.LeakyReLU(0.01)
